...
<html lang="en" xmlns:v="urn:schemas-microsoft-com:vml" xmlns:o="urn:schemas-microsoft-com:office:office">
  ...
  <body style="margin: 0; width: 100%; padding: 0; word-break: break-word; -webkit-font-smoothing: antialiased; background-color: #eceff1;">
    <div style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly; display: none;">{{$body->preheeader}}</div>
                    ...
                    <tr>
                      <td class="sm-px-24" style="mso-line-height-rule: exactly; border-radius: 4px; background-color: #ffffff; padding: 48px; text-align: left; font-family: Montserrat, -apple-system, 'Segoe UI', sans-serif; font-size: 16px; line-height: 24px; color: #626262;">
                        ...
                        <p style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly; margin: 0; margin-top: 24px; margin-bottom: 24px;">
                          ...
                          Nous avons reçu une demande de réinitialisation de votre mot de passe pour votre compte sur {{env('APP_NAME')}}. Pour finaliser la réinitialisation du mot de passe, veuillez utiliser le code de réinitialisation suivant :
                          <br style="margin-top : 20px;">
                          Code de réinitialisation : <b>{{$data['code']}}</b>
                          <br style="margin-top : 20px;">
                          Si vous n'avez pas initié cette demande de réinitialisation de mot de passe, veuillez ignorer cet e-mail. Votre mot de passe actuel restera inchangé.
                        </p>
                        <table style="width: 100%;" cellpadding="0" cellspacing="0" role="presentation">
                          <tr>
