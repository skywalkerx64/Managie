...
trait HasStatuses
{
    ...
    public function setStatus(string $name, ?string $reason = null, $user_id = null): self
    {
    ...
    public function forceSetStatus(string $name, ?string $reason = null, $user_id=null): self
    {
